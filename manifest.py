...
job_directory = os.path.join(ROOT_DIR, 'experiments/')
...
# CSV file for building demographics
wb_csv = "/projects/b1139/data/WB_crude_birthrate_by_year_and_country.csv"
